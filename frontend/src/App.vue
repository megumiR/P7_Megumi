        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-8 col-md-7 py-4">
              ...
              <p class="text-white">
                Bienvenue sur Groupomania chat! Ce site est crée pour communiquer facilement entre des collegues de
                Groupomania. Incrivez-vous par "Loguin"et ecrivez vos articles par "Ajouter un post" !
              </p>
            </div>
