...
*/
module.exports = (req, res, next) => {  // if (passvalidatorSchema.validate(req.body.email)) {
    if (mailvalidator.validate(req.body.email)) {  //.validate -Methode à valider le mot de passe contre schema
        next();
    } else {
